...
const User = () => {
    ...
    useEffect(() => {
        ...
        const getUserData = async () => {
            const useData = await getUserAndRepos(params.login);
            dispatch({ type: "GET_USER_AND_REPOS", payload: useData })
        }
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
                        <div className="custom-card-image mb-6 md:mb-0">
                            <div className="rounded-lg shadow-xl card image-full">
                                ...
                                <div className="card-body justify-end gap-1">
                                    <h2 className='card-title mb-0 capitalize text-slate-300'>{name}</h2>
                                    <p className='flex-grow-0 text-slate-300'>{login}</p>
                                </div>
                            </div>
                        </div>
